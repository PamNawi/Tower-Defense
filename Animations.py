...
#Game Entitys
lImagesGrass    = ([".//Resources//grassBorda.png"],1)
lImagesGraph    = ([".//Resources//grass.png"],1)
lImagesVillage  = ([".//Resources//city.png"],1)

#Obstacles
lImagesMountain = ([".//Resources//mountain.png"],1)
lImagesTree0 = ([".//Resources//Tree0.png"],1)
lImagesTree1 = ([".//Resources//Tree1.png"],1)
lImagesTree2 = ([".//Resources//Tree2.png"],1)
lImagesTree3 = ([".//Resources//Tree3.png"],1)
...
lImagesPortal = []
for i in range(0,31):
    lImagesPortal += [".//Resources//Portal//"+str(i)+".png"]
lImagesPortal = (lImagesPortal,0.3)
